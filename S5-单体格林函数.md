...
\end{equation}
$$
当$E=E_{n}$时，由式(\ref{7})(\ref{8})$G_{0}^{-1}\left(  E_{n}\right)  \left\vert \psi\right\rangle -G_{0}^{-1}\left(  E_{n}\right)  \left\vert \varphi_{n}\right\rangle =H_{1}\left\vert \psi\right\rangle
\]$
$$
\begin{equation}
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg3MDE3NTgsNjcyNTY2NjQyXX0=
-->