...
在初始点$x_1$，需要指定$N$个初值$y_i$，但是要受$n_1$个条件的约束，因此有$n_2=N-n_1$可自由指定的初值。将这些自由指定的变量看作矢量$\bold{V}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMzkwNjgxOTMsMTQ5NDQxNDcwOSwxND
k0NDE0NzA5LC0xMjQ4NDY2MDk1LC0yMDg4NzQ2NjEyXX0=
-->