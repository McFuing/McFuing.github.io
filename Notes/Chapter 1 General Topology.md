...
>2.若$T$中的两个开集为$T_S,T'_S$，则$\mathcal{T}_X=X\cap T_S,\mathcal{T}_X'=X\cap T'_S$,所以$\mathcal{T}_X \cap \mathcal{T}_X'=(X\cap T_S)\cap(X\cap T'_S)=$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk3MTQ3NzI0LDE5NDgwMjE5MTAsNTcwNz
