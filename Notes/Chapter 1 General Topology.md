...
\hspace{1cm}1.整个集合S以及空集\emptyset都在这个子集族中;\\
\hspace{1cm}2.给定有限数量的子集U_{1},U_{2},\cdots,U_{n},他们的交\cap_{i=1}^{n}U_{i}也属于子集族中;\\
\hspace{1cm}3.给定任意数量(有限或无限)的子集族中的集合，他们的并也属于这个子集族.
$$
为什么要求有限的交属于这个子集族，而不是无限数量的集合相交？

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNzEwMzA3OTUsMTQxMjE4ODUyLDc4Mz
AyNzQ1OCwxNjk2NzM0MzUzLDEzMDA0Mzg5MjUsNDE4NjQxMTdd
fQ==
-->