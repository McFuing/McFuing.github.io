...
>2.若$T$中的两个开集为$T_S,T'_S$，则$\mathcal{T}_X=X\cap T_S,\mathcal{T}_X'=X\cap T'_S$,所以$\mathcal{T}_X \cap \mathcal{T}_X'=(X\cap T_S)\cap()$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTg0MjIzMjQsMTk0ODAyMTkxMCw1Nz
...
NzExMDQsLTMyNTIyMDMxLC0xODQwNDc2ODczLDEwNjUyNjA5Nj
csMTc0MDE3NDM5MCwzODMyODE5MTAsLTE4NjM3Nzg1NDYsLTI5
OTk5MjMzN119
-->