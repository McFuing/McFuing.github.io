...
$z=\infty$对于方程(2)的解析性质就等价于$t=0$对于方程(11)的解析性质。
 1. 当$t=0$是常点时，要求$$p\left(\frac{1}{t}\right)=2t+p_2t^{2}+p_{3}t^{3}+\cdots\tag{12}$$以及$$q\left(\frac{1}{t}\right)=q_{4}t^{4}+q_{5}t^{5}+\cdots\tag{13}$$也即$$p(z)=\frac{2}{z}+\frac{p_2}{z^{2}}+\cdots;q(z)=\frac{q_4}{z^{4}}+\frac{q_5}{z^5}+\cdots\tag{14}$$
 3. 当$t=0$是正则奇点时，要求(10)成立，即$$\frac{1}{t}p\left(\frac{1}{t}\right)和\frac{1}{t^2}q\left(\frac{1}{t}\right)\tag{15}$$在$t=0$的邻域内是解析的。 
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjQyNDgxNDkyLDIwMzA5NjE4NjgsNDI5ND
gwNDU5LDM3NjUzMDgwNCwxODk5Mjc2MjkyLC02MjA2Nzg2OTQs
LTYwNzEyODgxOSwtNDg4MDQ4MDcsLTc4NTEzMzY5MCwtMTUxND
M4NDI4MywxMDUzMjM3NTg3LDE5MTU3NTk4MSwxNjYzMTIyNDcy
LC0zNDA3MTMwMThdfQ==
-->