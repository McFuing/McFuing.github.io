...
\end{aligned}
$$
其中$H_k=\sum_{n=k+1}^{+\infty}C_n^{k+1}h_n(z_0-z_1)^{n-k-1}$，等式的第二项可以看作$z_0$邻域上的全纯函数[^7]$\phi(z)$，因为$f(z)$在复平面上仅有一个一阶奇点$z_0$，我们总可以将幂级数做解析延拓，使得$\phi(z)$在全平面上解析，即
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODc3NjQ0MjEsLTE3NDAxMTQyNjIsLT
E5ODg2NzAyMDAsLTcyNzE4MzY3OSwtMjEwNTYwNjQxMCwtMTA2
OTA0NDQxLC0xNjYyNDE1Mzk3LDE3MDkxNTM5ODcsLTE4NDQ2Mz
MyMjQsLTE3MzU0MDg1MTEsMTQ4NjgxNTczNCwtMTcxMDY2OTM2
MSwyMDMwOTYxODY4LDQyOTQ4MDQ1OSwzNzY1MzA4MDQsMTg5OT
I3NjI5MiwtNjIwNjc4Njk0LC02MDcxMjg4MTksLTQ4ODA0ODA3
LC03ODUxMzM2OTBdfQ==
-->