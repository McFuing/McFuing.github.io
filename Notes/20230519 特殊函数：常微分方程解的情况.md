...
&=\frac{h_0}{z-z_0}+h_1\left(1+\frac{z_0-z_1}{z-z_0}\right)+h_2\left[\frac{(z_0-z_1)^2}{z-z_0}+2(z_0-z_1)+(z-z_0)\right]+h_3\left[\frac{(z_0-z_1)^3}{z-z_0}+3(z_0-)\right]\tag{18}
\end{aligned}
$$
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyNDI0ODkyNSwtMjEwNTYwNjQxMCwtMT
