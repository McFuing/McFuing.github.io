...
$z=\infty$对于方程(2)的解析性质就等价于$t=0$对于方程(11)的解析性质。
 1. 当$t=0$是常点时，要求$$p\left(\frac{1}{t}\right)=2t+p_2t^{2}+p_{3}t^{3}+\cdots\tag{12}$$以及$$q\left(\frac{1}{t}\right)=q_4t^{4}+q_5t^{5}+\cdots\tag{13}$$也即$$p(z)=\frac{2}{z}+\frac{p_2}{z^2}+\cdots;q(z)=\frac{q_4}{z^4}+\frac{q_5}{z^5}+\cdots\tag{14}$$
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI4MzQwMDkyMiwyMDMwOTYxODY4LDQyOT
Q4MDQ1OSwzNzY1MzA4MDQsMTg5OTI3NjI5MiwtNjIwNjc4Njk0
LC02MDcxMjg4MTksLTQ4ODA0ODA3LC03ODUxMzM2OTAsLTE1MT
QzODQyODMsMTA1MzIzNzU4NywxOTE1NzU5ODEsMTY2MzEyMjQ3
MiwtMzQwNzEzMDE4XX0=
-->