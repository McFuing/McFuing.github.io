...
$$
\begin{aligned}
f(z)&=\frac{1}{(z-z_0)^n}\sum_{n=0}^{+\infty}h_n(z-z_1)^n\\
&=\frac{1}{(z-z_0)^n}\left[h_0+h_1(z-z_1)+h_2(z-z_1)^2+h_3(z-z_1)^3+\dots\right]\\
&=\frac{h_0}{(z-z_0)^n}+h_1\frac{z-z_0+z_0-z_1}{(z-z_0)^n}+h_2(z-z_1)+h_3(z-z_1)^2+\dots\\
&=\tag{18}
\end{aligned}
$$
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDk3MzkzNjM5LC0xMDY5MDQ0NDEsLTE2Nj
