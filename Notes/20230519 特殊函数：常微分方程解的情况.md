...
根据式(15)可得,
$$
\frac{1}{t^2}q\left(\frac{1}{t}\right)=\sum_{r=1}^n\frac{B_rg_r\left(\frac{1}{t}\right)}{(1-z_rt)^2}+\sum_{r=1}^n\frac{C_rh_3\left(\frac{1}{t}\right)}{t(1-z_rt)}+\frac{\varphi}{t^2}\tag{19}
$$
所以$\varphi(z\rightarrow\infty)=0$，
$$
\sum_{r=1}^nC_rh_3(z)=0\tag{20}
$$
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjkwMDU0MSwtMTg0NDYzMzIyNCwtMT
