...
\end{aligned}
$$
且$C_1+C_2+C_3=0$，当其中的一个奇点为$z_3=\infty$时，式(22)可以化为
$$
u''+\left(\frac{A_1}{z-z_1}+\frac{A_2}{z-z_2}\right)u'
+\left[\frac{B_1}{(z-z_1)^2}+\frac{B_2}{(z-z_2)^2}+\frac{C_1}{z-z_1}+\frac{C_2}{z-z_2}\right]u=0,C_1=-C_2\tag{23}
$$
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTU2NzYyMjUsLTQ4ODA0ODA3LC03OD
