...
$$
\begin{aligned}
u''+\left(\frac{A_1}{z-z_1}+\frac{A_2}{z-z_2}+\frac{A_3}{z-z_3}\right)u'+\left[\frac{B_1}{(z-z_1)^2} \\
&+\frac{B_2}{(z-z_2)^2}+\frac{B_3}{(z-z_3)^2}+\frac{C_1}{z-z_1}+\frac{C_2}{z-z_2}+\frac{C_3}{z-z_3}\right]u=0\tag{22}
\end{aligned}
$$
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUyNzY2Mzk4MywtNzg1MTMzNjkwLC0xNT
