...
$$
p(z)=\sum_{r=1}^{n}\frac{A_rh_1(z)}{z-z_r}+\varphi(z)\tag{16}
$$
其中$A_r$为$p(z)$在$z=z_r$处的留数[^3] ，$h_1(z),\varphi(z)$是全平面解析的函数，因为$z\rightarrow \infty(t\rightarrow0)$且无穷是方程的正则奇点，所以由式(15)可知，$\varphi(z\rightarrow\infty)=0$，由刘维尔定理可知[^4] ，$\varphi(z)=0$，所以
$$
p(z)=\sum_{r=1}^{n}\frac{A_rh_1(z)}{z-z_r}\tag{17}
$$
...
同理对于$q(z)$，奇点最多为二阶奇点，
$$
q(z)=\sum_{r=1}^n\left[\frac{B_rh_2(z)}{(z-z_r)^2}+\frac{C_rh_3(z)}{z-z_r}\right]+\varphi(z)\tag{18}
$$
根据式(15)可得,
$$
\frac{1}{t^2}q\left(\frac{1}{t}\right)=\sum_{r=1}^n\frac{B_rh_2\left(\frac{1}{t}\right)}{(1-z_rt)^2}+\sum_{r=1}^n\frac{C_rh_3\left(\frac{1}{t}\right)}{t(1-z_rt)}+\frac{\varphi}{t^2}\tag{19}
$$
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MzU0MDg1MTEsMTQ4NjgxNTczNCwtMT
cxMDY2OTM2MSwyMDMwOTYxODY4LDQyOTQ4MDQ1OSwzNzY1MzA4
MDQsMTg5OTI3NjI5MiwtNjIwNjc4Njk0LC02MDcxMjg4MTksLT
Q4ODA0ODA3LC03ODUxMzM2OTAsLTE1MTQzODQyODMsMTA1MzIz
NzU4NywxOTE1NzU5ODEsMTY2MzEyMjQ3MiwtMzQwNzEzMDE4XX
0=
-->