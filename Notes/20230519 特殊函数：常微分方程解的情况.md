...
## 富克斯(Fuchs)型方程
### 极点
我们先来回忆一下极点的相关知识，当函数$f(z)$在$z=z_0\in \Omega$处有一个$n$阶极点，那么有
$$
f(z)=\frac{h(z)}{z-z_0}\tag{16}
$$
其中$h(z)$为$z_0$的邻域内的全纯函数。我们将$h(z)$在$|z-z_0|<R$的邻域内展开，
$$
...
[^7]:函数仅含有可去奇点时，可以通过解析延拓化为qun'chun'han'shu
$$
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxNTc0MDI3NywtMTY2MjQxNTM5NywxNz
A5MTUzOTg3LC0xODQ0NjMzMjI0LC0xNzM1NDA4NTExLDE0ODY4
MTU3MzQsLTE3MTA2NjkzNjEsMjAzMDk2MTg2OCw0Mjk0ODA0NT
ksMzc2NTMwODA0LDE4OTkyNzYyOTIsLTYyMDY3ODY5NCwtNjA3
MTI4ODE5LC00ODgwNDgwNywtNzg1MTMzNjkwLC0xNTE0Mzg0Mj
gzLDEwNTMyMzc1ODcsMTkxNTc1OTgxLDE2NjMxMjI0NzIsLTM0
MDcxMzAxOF19
-->