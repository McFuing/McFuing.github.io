...
&=\frac{\sum_{n=0}^{+\infty}h_n(z_0-z_1)^n}{z-z_0}+\sum_{n=1}^{+\infty}nh_n(z_0-z_1)^{n-1}+(z-z_0)\sum_{n=2}^{+\infty}C_n^2(z_0-z_1)^{n-2}+\dots\\
&=\frac{H_0}{z-z_0}+\sum_{k=0}^{+\infty}H_k(z-z_0)^k\tag{18}
\end{aligned}
$$
其中$H_k=\sum_{n=k+1}^{+\infty}C_n^{k+1}h_n$等式的第二项可以看作邻域上的全纯函数[^7]$\phi(z)$，即
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA2MTQ3Njk5NiwtMTk4ODY3MDIwMCwtNz
I3MTgzNjc5LC0yMTA1NjA2NDEwLC0xMDY5MDQ0NDEsLTE2NjI0
MTUzOTcsMTcwOTE1Mzk4NywtMTg0NDYzMzIyNCwtMTczNTQwOD
UxMSwxNDg2ODE1NzM0LC0xNzEwNjY5MzYxLDIwMzA5NjE4Njgs
NDI5NDgwNDU5LDM3NjUzMDgwNCwxODk5Mjc2MjkyLC02MjA2Nz
g2OTQsLTYwNzEyODgxOSwtNDg4MDQ4MDcsLTc4NTEzMzY5MCwt
MTUxNDM4NDI4M119
-->