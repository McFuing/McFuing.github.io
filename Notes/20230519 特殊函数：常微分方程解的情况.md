...
&=\frac{h_0}{z-z_0}+h_1\left(1+\frac{z_0-z_1}{z-z_0}\right)+h_2\left[\frac{(z_0-z_1)^2}{z-z_0}+2(z_0-z_1)+(z-z_0)\right]\\&+h_3\left[\frac{(z_0-z_1)^3}{z-z_0}+3(z_0-z_1)^2+3(z_0-z_1)(z-z_0)+(z-z_0)^2\right]+\dots\\
&=\frac{h_0+h_1(z_0-z_1)+h_2(z_0-z_1)^2+h_3(z_0-z_1)^3+\dots}{z-z_0}\\&
+\left[h_1+2(z_0-z_1)h_2+3(z_0-z_1)^2h_3+\dots\right]+\dots\\
&=\frac{\sum_{n=0}^{+\infty}h_n(z_0-z_1)^n}{z-z_0}+\sum_{n=1}^{+\infty}nh_n(z_0-z_1)^{n-1}+(z-z_0)\sum\tag{18}
\end{aligned}
$$
其中等式的第二项可以看作邻域上的全纯函数[^7]$\phi(z)$，即
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4NjkwMjQ1MSwtNzI3MTgzNjc5LC0yMT
A1NjA2NDEwLC0xMDY5MDQ0NDEsLTE2NjI0MTUzOTcsMTcwOTE1
Mzk4NywtMTg0NDYzMzIyNCwtMTczNTQwODUxMSwxNDg2ODE1Nz
M0LC0xNzEwNjY5MzYxLDIwMzA5NjE4NjgsNDI5NDgwNDU5LDM3
NjUzMDgwNCwxODk5Mjc2MjkyLC02MjA2Nzg2OTQsLTYwNzEyOD
gxOSwtNDg4MDQ4MDcsLTc4NTEzMzY5MCwtMTUxNDM4NDI4Mywx
MDUzMjM3NTg3XX0=
-->