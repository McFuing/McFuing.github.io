...
\end{aligned}
$$
其中$H_k=\sum_{n=k+1}^{+\infty}C_n^{k+1}h_n(z_0-z_1)^{n-k-1}$，等式的第二项可以看作$z_0$邻域上的全纯函数[^7]$\phi(z)$，因为$f(z)$在复平面上仅有一个一阶奇点$z_0$，我们总可以将幂级数zuo'jie'xi'yan，那么$\phi(z)$全平面解析，即
...
&+\left[\frac{B_1}{(z-z_1)^2}+\frac{B_2}{(z-z_2)^2}+\frac{B_3}{(z-z_3)^2}+\frac{C_1}{z-z_1}+\frac{C_2}{z-z_2}+\frac{C_3}{z-z_3}\right]u=0\tag{26}
\end{aligned}
$$
且其中$C_1+C_2+C_3=0$。当其中的一个奇点为$z_3=\infty$时，式(26)可以化为
$$
u''+\left(\frac{A_1}{z-z_1}+\frac{A_2}{z-z_2}\right)u'
+\left[\frac{B_1}{(z-z_1)^2}+\frac{B_2}{(z-z_2)^2}+\frac{C_1}{z-z_1}-\frac{C_1}{z-z_2}\right]u=0\tag{27}
$$
我们再要求$z_1=0,z_2=1$且均为一阶极点时，
$$
\begin{aligned}
u''+\left(\frac{A_1}{z}+\frac{A_2}{z-1}\right)u'+\left(\frac{C_1}{z}-\frac{C_1}{z-1}\right)u&=0\\
z(1-z)u''+\left[A_1-(A_1+A_2)z\right]u'+C_1u&=0\tag{28}
\end{aligned}
$$
我们对(28)式进行重参数化可以化为，
$$
...
方程的奇点为$0,1,a,\infty$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc0NTA1MjAwMCwtMTc0MDExNDI2MiwtMT
k4ODY3MDIwMCwtNzI3MTgzNjc5LC0yMTA1NjA2NDEwLC0xMDY5
MDQ0NDEsLTE2NjI0MTUzOTcsMTcwOTE1Mzk4NywtMTg0NDYzMz
IyNCwtMTczNTQwODUxMSwxNDg2ODE1NzM0LC0xNzEwNjY5MzYx
LDIwMzA5NjE4NjgsNDI5NDgwNDU5LDM3NjUzMDgwNCwxODk5Mj
c2MjkyLC02MjA2Nzg2OTQsLTYwNzEyODgxOSwtNDg4MDQ4MDcs
LTc4NTEzMzY5MF19
-->