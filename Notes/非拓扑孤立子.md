...
这个解如何找呢？  
我们先看一下当$r\rightarrow\infty$时，真空态要求$\phi\rightarrow0$，我们总可以做到使$U(\phi\rightarrow0)\rightarrow0$，其实$U(\phi\rightarrow0)\rightarrow\mu^2\phi^2$，所以$U'(\phi)$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDAxMDU3NSwtMTc1OTM5MjEzMSwtOT
