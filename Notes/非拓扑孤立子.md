...
$$
E-\omega N=\int \dot{\phi}_1^2+\dot{\phi}_2^2+(\partial_r\phi_1)^2+(\partial_r\phi_2)^2+V(\phi_1^2+\phi_2^2)d^3x-2\omega\int \phi_1\dot{\phi}_2-\phi_2\dot{\phi}_1 d^3x
$$
其中$\omega$为拉式乘子。可以得到，

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDIxMTI2NTksLTk3NDM2MzQyLC0xND
