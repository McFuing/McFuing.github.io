...
$$
如果$\omega^2\geq\frac{1}{2}U''(0)$，我们的边界条件将会正比$e^{ikr}$，但我们要的是孤子解，束缚态解。所以我们得到的第一个约束为$\omega^2<\frac{1}{2}U''(0)$也即$V$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NDE0MjYwMzksLTIwODg5MjAwNDgsLT
