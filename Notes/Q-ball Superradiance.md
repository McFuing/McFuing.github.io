...
$$
#### 非转动Q-ball 
让我们看一下对于仅仅有一个入射波$\eta_+(m=0)$，能量振幅因子$\mathcal{A}_E$随入射频率$\omega$和背景$\omega_Q$如何变化，如图2所示。(如果我们仅仅有入射$\eta_-$波，放大曲线将会翻转)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4MTAyMzczNSwxMTg3MTU1NDAzLC0xMz
