...
总结一下，由于Q-ball在场空间的相干转动，我们已经发现Q-ball可以诱导入射的波发生超辐射。对于转动Q-ball，在实空间的额外的转动可以更进一步地加强超辐射。Q-ball散射的一个重要的特征是它涉及了两个耦合的模式，这对于Q-ball发生超辐射是必须的。由于两个耦合模式的存在，超辐射谱也变得更加丰富。在散射中，能量和角动量都可以被加强，从Q-ball里面汲取能量和角动量。然而，能量与角动量的超辐射并不总是同时发生。当入射波包含正和负的频率的模式，

<!--stackedit_data:
eyJoaXN0b3J5IjpbNDAwNjc2NiwtMTk1MTcxNDE4MywtMTQ4Nz
M5NDEyOSw2MDkwNDgzNTEsMTk3MDA0MzU3NSwxNjc4NTc3MDg2
LC0xODY1MTI1NDA2LDEyOTcwNjkyMzgsLTIwNTU4NjI0MzMsMT
c0NzQ4MTg5MiwtMTM5ODYyNjA0NSwxOTA4OTQ5ODE5LC0yMDE2
NDY4MzAzLC03ODEwMjM3MzUsMTE4NzE1NTQwMywtMTM0Njk2ND
AwMiwxMzUwNzM3MDAsLTE0MzUzMTkxMDQsLTE4MzU2MDYxMzQs
MTQyOTczNjc5N119
-->