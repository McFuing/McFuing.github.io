...
Q-ball作为孤子解[1-3]出现在很多的允许吸引的非线性相互作用的场[4].相互作用的吸引力允许电荷凝结成局部物体，但这不是静态场构型，因为场的相位随时间演变，从而避免Derrick定理[5] 。Q-ball在获得一些角动量后可能会旋转并在中心变得空心[6-10]，这可能发生在从具有
非零角动量或Q球碰撞[11]。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ3NDY2MzQyMCwxODA0ODQwMjYwLDE4NT
