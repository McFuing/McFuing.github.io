...
在这个文章中，我们将指出Q-ball也可以超辐射，尽管Q球的历史悠久，但是一个迄今为止未知的性质。Q-ball超辐射源于这样一个事实，即Q-ball场是复的，有两个组成部分，并且Q-ball的解的相位随时间演变。
我们将会考虑$U(1)$对称性的理论，
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU2NDA0OTI4NywxODA0ODQwMjYwLDE4NT
