...
$$
\mathcal{A}_E=\rightbracket(\frac{\frac{\omega_+^2}{k_+}|A_+|^2+\frac{\omega_-^2}{k_-}|B_-^2|}{\frac{\omega_+^2}{k_+}|B_+|^2+\frac{\omega_-^2}{k_-}|A_-^2|})^{sign(\omega)},\tag{11}
$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjU1OTY3OTAxLDE0Mjk3MzY3OTcsMTY3MD
