...
#### 转动Q-ball
当Q-ball在实空间转动时，转动超辐射的额外成分也会被激活，当$\eta_+$模式转动方向与Q-ball一致时，将会增强能量振幅(即$sign(\omega_+/m_+)=sign(\omega_Q/m_Q)$)，如图4右边展示的那样。另外一方面，对于相反的情况，
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk5MjAyMjE0LDEyOTcwNjkyMzgsLTIwNT
