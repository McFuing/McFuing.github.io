...
$$
\mathcal{A}_E=\leftbrackets(\frac{\frac{\omega_+^2}{k_+}|A_+|^2+\frac{\omega_-^2}{k_-}|B_-^2|}{\frac{\omega_+^2}{k_+}|B_+|^2+\frac{\omega_-^2}{k_-}|A_-^2|}\rightbrackets)^{sign(\omega)},\tag{11}
$$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyMTA3MDgxNiwxNDI5NzM2Nzk3LDE2Nz
