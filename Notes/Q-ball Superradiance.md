...
总结一下，由于Q-ball在场空间的相干转动，我们已经发现Q-ball可以诱导入射的波发生超辐射。对于转动Q-ball，在实空间的额外的转动可以更进一步地加强超辐射。Q-ball散射的一个重要的特征是它涉及了两个耦合的模式，这对于Q-ball发生超辐射是必须的。由于两个耦合模式的存在，超辐射谱也变得更加丰富。

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxMzk4OTM1NiwtMTQ4NzM5NDEyOSw2MD
